...
class ClaroPage {
  ...
  errorMessage =  '//div[@class="_2TFF_JfA5OPCpVYMonjCth Yrc_bTtHfRx3vNHJhbaFC _2q-NeFhUCHCF4iXsPDbGA_"]';
  ...
  loginWithCredentials(email, password) {
    I.waitForElement(this.loginButton, 10);
  ...
  seeProfilePage() {
    ...
    I.grabCurrentUrl().then((url) => {
      assert.ok(
        url.includes('/homeuser'),`Esperaba que la URL contuviera '/homeuser', pero fue: ${url}`
      );
